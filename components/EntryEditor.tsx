...
const EntryEditor: React.FC<EntryEditorProps> = ({ entries, onUpdate, onDelete, onAdd }) => {
            ...
            {entries.length === 0 ? (
              ...
              entries.map((entry) => (
                <tr key={entry.id} className="hover:bg-slate-800/50 transition-colors group">
                  ...
                  <td className="p-1">
                    <input type="text" value={entry.from} onChange={(e) => onUpdate(entry.id, 'from', e.target.value)} className={getFieldClass(entry, 'from', "bg-transparent w-full outline-none text-xs uppercase text-center rounded py-1.5")} />
                  </td>
                  <td className="p-1">
                    <input type="text" value={entry.to} onChange={(e) => onUpdate(entry.id, 'to', e.target.value)} className={getFieldClass(entry, 'to', "bg-transparent w-full outline-none text-xs uppercase text-center rounded py-1.5")} />
                  </td>
                  ...
                  <td className="p-1"><input type="text" value={entry.night} onChange={(e) => onUpdate(entry.id, 'night', e.target.value)} className={getFieldClass(entry, 'night', "bg-transparent w-full outline-none text-xs font-mono text-center rounded py-1.5")} /></td>
                  <td className="p-1"><input type="text" value={entry.crossCountry} onChange={(e) => onUpdate(entry.id, 'crossCountry', e.target.value)} className={getFieldClass(entry, 'crossCountry', "bg-transparent w-full outline-none text-xs font-mono text-center rounded py-1.5")} /></td>
                  <td className="p-1"><input type="text" value={entry.pic} onChange={(e) => onUpdate(entry.id, 'pic', e.target.value)} className={getFieldClass(entry, 'pic', "bg-transparent w-full outline-none text-xs font-mono text-center rounded py-1.5")} /></td>
                  <td className="p-1"><input type="text" value={entry.sic} onChange={(e) => onUpdate(entry.id, 'sic', e.target.value)} className={getFieldClass(entry, 'sic', "bg-transparent w-full outline-none text-xs font-mono text-center rounded py-1.5")} /></td>
                  <td className="p-1"><input type="text" value={entry.dualReceived} onChange={(e) => onUpdate(entry.id, 'dualReceived', e.target.value)} className={getFieldClass(entry, 'dualReceived', "bg-transparent w-full outline-none text-xs font-mono text-center rounded py-1.5")} /></td>
                  <td className="p-1"><input type="text" value={entry.dualGiven} onChange={(e) => onUpdate(entry.id, 'dualGiven', e.target.value)} className={getFieldClass(entry, 'dualGiven', "bg-transparent w-full outline-none text-xs font-mono text-center rounded py-1.5")} /></td>
                  <td className="p-1 bg-emerald-400/[0.05]"><input type="text" value={entry.instrument} onChange={(e) => onUpdate(entry.id, 'instrument', e.target.value)} className={getFieldClass(entry, 'instrument', "bg-transparent w-full outline-none text-xs font-mono text-center text-emerald-400 font-bold rounded py-1.5")} /></td>
                  <td className="p-1 bg-cyan-400/[0.05]"><input type="text" value={entry.simulatedInstrument} onChange={(e) => onUpdate(entry.id, 'simulatedInstrument', e.target.value)} className={getFieldClass(entry, 'simulatedInstrument', "bg-transparent w-full outline-none text-xs font-mono text-center text-cyan-400 rounded py-1.5")} /></td>
                  <td className="p-1 bg-amber-400/[0.05]"><input type="text" value={entry.approaches} onChange={(e) => onUpdate(entry.id, 'approaches', e.target.value)} className={getFieldClass(entry, 'approaches', "bg-transparent w-full outline-none text-xs font-mono text-center text-amber-500 font-bold rounded py-1.5")} /></td>
                  <td className="p-1"><input type="text" value={entry.landingsDay} onChange={(e) => onUpdate(entry.id, 'landingsDay', e.target.value)} className={getFieldClass(entry, 'landingsDay', "bg-transparent w-full outline-none text-xs font-mono text-center rounded py-1.5")} /></td>
                  <td className="p-1"><input type="text" value={entry.landingsNight} onChange={(e) => onUpdate(entry.id, 'landingsNight', e.target.value)} className={getFieldClass(entry, 'landingsNight', "bg-transparent w-full outline-none text-xs font-mono text-center rounded py-1.5")} /></td>
