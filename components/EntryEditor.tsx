...
import { LogbookEntry, BoundingBox } from '../types';
...
const EntryEditor: React.FC<EntryEditorProps> = ({ entries, images, onUpdate, onDelete, onAdd }) => {
  const [activeBoundingBox, setActiveBoundingBox] = useState<{ box: BoundingBox; fieldName: string } | null>(null);
  ...
  const handleFieldFocus = useCallback((entryId: string, fieldName: keyof LogbookEntry, entry: LogbookEntry) => {
    setActiveEntryId(entryId);
    const boundingBoxes = entry.fieldBoundingBoxes;
    if (boundingBoxes && boundingBoxes[fieldName]) {
      setActiveBoundingBox({
        box: boundingBoxes[fieldName]!,
  ...
  const handleFieldBlur = useCallback(() => {
    // Keep bounding box visible for a moment after blur for better UX
    // setActiveBoundingBox(null);
  }, []);
  ...
  const getFieldClass = (entry: LogbookEntry, field: string, base: string = "") => {
    ...
    return `${base} transition-all duration-300 ${uncertain ? 'bg-amber-500/10 border-amber-500/50 ring-1 ring-amber-500/30' : 'border-transparent'} ${isActive ? 'ring-1 ring-blue-500/50' : ''}`;
  };

  return (
    <Group orientation="horizontal" className="flex h-[calc(100vh-200px)]">
      {/* Left Panel: Entry Table */}
      <Panel defaultSize={60} minSize={40} className="flex flex-col bg-slate-900 rounded-xl overflow-hidden border border-slate-800 shadow-2xl">
                  ...
                  <tr key={entry.id} className="hover:bg-slate-800/50 transition-colors group">
                    ...
                    <td className="p-1 sticky left-24 bg-slate-900 group-hover:bg-slate-800 z-20 border-r border-slate-700">
                      <input 
                        ...
                        onFocus={() => handleFieldFocus(entry.id, 'date', entry)}
                    ...
                    <td className="p-1 sticky left-56 bg-slate-900 group-hover:bg-slate-800 z-20 border-r border-slate-700 shadow-[4px_0_8_rgba(0,0,0,0.3)]">
                      <input 
                        ...
                        onFocus={() => handleFieldFocus(entry.id, 'aircraftId', entry)}
                        onBlur={handleFieldBlur}
                    ...
                    <td className="p-1">
                      <input 
                        ...
                        onFocus={() => handleFieldFocus(entry.id, 'comments', entry)}
                        onBlur={handleFieldBlur}
                    ...
                    <td className="p-1">
                      <input 
                        ...
                        onFocus={() => handleFieldFocus(entry.id, 'from', entry)}
                        onBlur={handleFieldBlur}
                    ...
                    <td className="p-1">
                      <input 
                        ...
                        onFocus={() => handleFieldFocus(entry.id, 'to', entry)}
                        onBlur={handleFieldBlur}
                    ...
                    <td className="p-1 bg-blue-500/[0.03]">
                      <input 
                        ...
                        onFocus={() => handleFieldFocus(entry.id, 'totalTime', entry)}
                        onBlur={handleFieldBlur}
                    ...
                    <td className="p-0.5 w-10">
                      <input 
                        ...
                        onFocus={() => handleFieldFocus(entry.id, 'day', entry)}
                        onBlur={handleFieldBlur}
                    ...
                    <td className="p-1">
                      <input 
                        ...
                        onFocus={() => handleFieldFocus(entry.id, 'night', entry)}
                        onBlur={handleFieldBlur}
                    ...
                    <td className="p-1">
                      <input 
                        ...
                        onFocus={() => handleFieldFocus(entry.id, 'crossCountry', entry)}
                        onBlur={handleFieldBlur}
                    ...
                    <td className="p-1">
                      <input 
                        ...
                        onFocus={() => handleFieldFocus(entry.id, 'pic', entry)}
                        onBlur={handleFieldBlur}
                    ...
                    <td className="p-1">
                      <input 
                        ...
                        onFocus={() => handleFieldFocus(entry.id, 'sic', entry)}
                        onBlur={handleFieldBlur}
                    ...
                    <td className="p-1">
                      <input 
                        ...
                        onFocus={() => handleFieldFocus(entry.id, 'dualReceived', entry)}
                        onBlur={handleFieldBlur}
                    ...
                    <td className="p-1">
                      <input 
                        ...
                        onFocus={() => handleFieldFocus(entry.id, 'dualGiven', entry)}
                        onBlur={handleFieldBlur}
                    ...
                    <td className="p-1 bg-emerald-400/[0.05]">
                      <input 
                        ...
                        onFocus={() => handleFieldFocus(entry.id, 'instrument', entry)}
                        onBlur={handleFieldBlur}
                    ...
                    <td className="p-1 bg-cyan-400/[0.05]">
                      <input 
                        ...
                        onFocus={() => handleFieldFocus(entry.id, 'simulatedInstrument', entry)}
                        onBlur={handleFieldBlur}
                    ...
                    <td className="p-1 bg-amber-400/[0.05]">
                      <input 
                        ...
                        onFocus={() => handleFieldFocus(entry.id, 'approaches', entry)}
                        onBlur={handleFieldBlur}
                    ...
                    <td className="p-1">
                      <input 
                        ...
                        onFocus={() => handleFieldFocus(entry.id, 'landingsDay', entry)}
                        onBlur={handleFieldBlur}
                    ...
                    <td className="p-1">
                      <input 
                        ...
                        onFocus={() => handleFieldFocus(entry.id, 'landingsNight', entry)}
                        onBlur={handleFieldBlur}
      ...
      {/* Resize Handle */}
      <Separator className="w-1 bg-slate-800 hover:bg-slate-700 transition-colors cursor-col-resize" />

      {/* Right Panel: Image Viewer */}
      <Panel defaultSize={40} minSize={30} className="flex flex-col bg-slate-900 rounded-xl overflow-hidden border border-slate-800">
        {images.length > 0 ? (
          <ImageViewer
            images={images}
            activeBoundingBox={activeBoundingBox?.box || null}
            fieldName={activeBoundingBox?.fieldName}
          />
        ) : (
          <div className="flex items-center justify-center h-full text-slate-500">
            <div className="text-center">
              ...
              <p className="text-xs text-slate-600 mt-1">Focus on a field to view its location</p>
            </div>
          </div>
        )}
      </Panel>
