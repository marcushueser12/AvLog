      ...
      <div className="flex items-center border-b border-slate-800">
        ...
        <div className="flex items-center gap-3 px-4 py-3 border-r border-slate-800 bg-slate-950/50">
          <input
            ...
            className="w-5 h-5 rounded border-2 border-slate-600 bg-slate-800 text-emerald-600 focus:ring-2 focus:ring-emerald-500 focus:ring-offset-0 cursor-pointer"
          />
