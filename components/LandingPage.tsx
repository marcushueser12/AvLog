...
const LandingPage: React.FC<LandingPageProps> = ({ onStart }) => {
  ...
  const menuItems = [
    ...
    { id: 'permanent-log', label: 'Permanent Log', icon: ICONS.History, desc: 'View your digital history' },
            ...
            <div className="relative" ref={menuRef}>
                ...
                {isMenuOpen && (
                    <div className="absolute right-0 mt-3 w-72 bg-slate-900 border border-slate-800 rounded-3xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 slide-in-from-top-2 duration-200 z-[100]">
                        ...
                        <div className="p-4 bg-blue-600/5 text-center border-t border-slate-800">
                             <p className="text-[10px] text-slate-500 font-medium">Logged in as <span className="text-slate-300">John Doe</span></p>
                        </div>
                    </div>
                )}
            </div>
