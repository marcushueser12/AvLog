                ...
                >
                  <motion.div className="p-3 bg-white/80 backdrop-blur-sm border border-[#E2E8F0] rounded-xl shadow-sm">
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-[9px] font-semibold text-[#003366]/70">Total</span>
                  ...
                  <motion.div className="p-3 bg-white/80 backdrop-blur-sm border border-[#E2E8F0] rounded-xl shadow-sm">
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-[9px] font-semibold text-[#003366]/70">PIC</span>
                      <Plane className="w-3 h-3 text-[#007BFF]" />
                    </div>
                  ...
                  <motion.div className="p-3 bg-white/80 backdrop-blur-sm border border-[#E2E8F0] rounded-xl shadow-sm">
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-[9px] font-semibold text-[#003366]/70">XC</span>
                      <Plane className="w-3 h-3 text-[#007BFF]" />
                    </div>
