                  ...
                  <div className="space-y-12">
                    {pendingVerificationScans.map(scan => {
                      ...
                      const calculatedTotals: PageTotals = {
                        ...
                        mel: scanEntries.reduce((acc, e) => acc + (parseFloat(e.mel || '') || 0), 0).toFixed(1),
                        seaplaneTime: scanEntries.reduce((acc, e) => acc + (parseFloat(e.seaplaneTime || '') || 0), 0).toFixed(1),
                        simulatorTime: scanEntries.reduce((acc, e) => acc + (parseFloat(e.simulatorTime || '') || 0), 0).toFixed(1),
                  ...
                  <section className="space-y-4">
                    ...
                    <div className="space-y-6">
                      {pendingVerificationScans.map(scan => {
                        ...
                        const pageNumber = scan.pageNumber || 1;
                        const isVerified = scan.isVerified || false;
                        const calculatedTotals: PageTotals = { totalTime: scanEntries.reduce((acc, e) => acc + (parseFloat(e.totalTime) || 0), 0).toFixed(1), day: scanEntries.reduce((acc, e) => acc + (parseFloat(e.day) || 0), 0).toFixed(1), night: scanEntries.reduce((acc, e) => acc + (parseFloat(e.night) || 0), 0).toFixed(1), crossCountry: scanEntries.reduce((acc, e) => acc + (parseFloat(e.crossCountry) || 0), 0).toFixed(1), pic: scanEntries.reduce((acc, e) => acc + (parseFloat(e.pic) || 0), 0).toFixed(1), sic: scanEntries.reduce((acc, e) => acc + (parseFloat(e.sic) || 0), 0).toFixed(1), mel: scanEntries.reduce((acc, e) => acc + (parseFloat(e.mel || '') || 0), 0).toFixed(1), seaplaneTime: scanEntries.reduce((acc, e) => acc + (parseFloat(e.seaplaneTime || '') || 0), 0).toFixed(1), simulatorTime: scanEntries.reduce((acc, e) => acc + (parseFloat(e.simulatorTime || '') || 0), 0).toFixed(1), dualReceived: scanEntries.reduce((acc, e) => acc + (parseFloat(e.dualReceived) || 0), 0).toFixed(1), dualGiven: scanEntries.reduce((acc, e) => acc + (parseFloat(e.dualGiven) || 0), 0).toFixed(1), instrument: scanEntries.reduce((acc, e) => acc + (parseFloat(e.instrument) || 0), 0).toFixed(1), simulatedInstrument: scanEntries.reduce((acc, e) => acc + (parseFloat(e.simulatedInstrument) || 0), 0).toFixed(1), approaches: scanEntries.reduce((acc, e) => acc + (parseInt(e.approaches) || 0), 0).toString(), landingsDay: scanEntries.reduce((acc, e) => acc + (parseInt(e.landingsDay) || 0), 0).toString(), landingsNight: scanEntries.reduce((acc, e) => acc + (parseInt(e.landingsNight) || 0), 0).toString() };
                        return (
